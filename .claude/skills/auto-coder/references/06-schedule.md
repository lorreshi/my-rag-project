...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2026-04-19 | |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026-04-25 | |
| A3 | 配置加载与校验（Settings） | [x] | 2026-04-25 | |

#### 阶段 B：Libs 可插拔层

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2026-05-03 | |
| B2 | Embedding 抽象接口与工厂 | [x] | 2026-05-03 | |
| B3 | Splitter 抽象接口与工厂 | [x] | 2026-05-03 | |
| B4 | VectorStore 抽象接口与工厂 | [x] | 2026-05-03 | |
...
| B7.3 | OpenAI & Azure Embedding 实现 | [x] | 2026-05-04 | |
| B7.4 | Ollama Embedding 实现 | [x] | 2026-05-04 | |
| B7.5 | Recursive Splitter 默认实现 | [x] | 2026-05-04 | |
| B7.6 | ChromaStore 默认实现 | [x] | 2026-05-04 | |
| B7.7 | LLM Reranker 实现 | [x] | 2026-05-04 | |
| B7.8 | Cross-Encoder Reranker 实现 | [x] | 2026-05-04 | |
| B8 | Vision LLM 抽象接口与工厂集成 | [x] | 2026-05-04 | |
| B9 | Azure Vision LLM 实现 | [x] | 2026-05-04 | |

#### 阶段 C：Ingestion Pipeline MVP

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| C1 | 定义核心数据类型/契约（Document/Chunk/ChunkRecord） | [x] | 2026-05-05 | |
